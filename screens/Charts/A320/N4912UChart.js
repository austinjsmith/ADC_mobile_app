...
class N4912UChart extends Component {
    ...
    render () {
        ...
        const barN4912UData = [0.24, 0, 0.25, 13.25, 1, 0, 7, 4, 1, 6, 3, 5, 2, 8, 1, 4,
                                2, 4, 0, 5, 3.5, 0, 2, 0.5, 3.4,
                                3, 0, 8, 1, 10, 8, 8, 3, 2, 0, 3, 2, 7.8, 0.75, 13, 0, 0
        ];
        ...
        return (
            <ScrollView horizontal>
                <View>
                    ...
                    <Text style={{backgroundColor: 'red', color: 'white'}}>N4912U Actual Time</Text>
                    <View style={{flex:0.1}}></View>
                    <Text style={{backgroundColor: '#00FF17', color: 'black'}}>Linear Est. Time</Text>
                    <View style={{flex:0.1}}></View>
                    <Text style={{backgroundColor: '#FFB600', color: 'black'}}>Linear N4912U Time</Text>
                </View>
                <ScrollView horizontal>
                    ...
                    >
                        ...
                        <Svg height="300" width={ScreenWidth}>
                            {/* Linear (EST. TIME) */}
                            <Polyline
                                points="0,260 1000,175"
                                fill="none"
                                stroke="#00FF17"
                                strokeWidth="4"
                            />
                            {/* Linear (N4912U ACTUAL) */}
                            <Polyline
                                points="0,250 1000,220"
                                fill="none"
                                stroke="#FFB600"
                                strokeWidth="4"
                            />
