...
class N1913UChart extends Component {
    ...
    render () {
        ...
        const barN1913UData = [0.25, 0, 0.5, 12, 1, 0, 5, 1.75, 0, 4.5, 4, 5.5, 1, 
            4, 1, 5.5, 2.5, 4, 0, 5, 3.5, 0, 2, 0.5, 3.4, 3, 0, 8, 8, 
            1, 10, 8, 3, 2, 0, 3, 2, 7.8, 0.75, 13, 0, 0
        ];
        ...
        return (
            <ScrollView horizontal>
                <View>
                    ...
                    <Text style={{backgroundColor: 'red', color: 'white'}}>N1913U Actual Time</Text>
                    <View style={{flex:0.1}}></View>
                    <Text style={{backgroundColor: '#00FF17', color: 'black'}}>Linear Est. Time</Text>
                    <View style={{flex:0.1}}></View>
                    <Text style={{backgroundColor: '#FFB600', color: 'black'}}>Linear N1913U Time</Text>
                </View>
                <ScrollView horizontal>
                    ...
                    >
                        ...
                        <Svg height="300" width={ScreenWidth}>
                            {/* Linear (EST. TIME) */}
                            <Polyline
                                points="0,270 1000,201"
                                fill="none"
                                stroke="#00FF17"
                                strokeWidth="4"
                            />
                            {/* Linear (N1913U ACTUAL) */}
                            <Polyline
                                points="0,265 1000,225"
                                fill="none"
                                stroke="#FFB600"
                                strokeWidth="4"
                            />
